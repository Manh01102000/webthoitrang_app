                            ...
                            <div class="hct_item_infor_detail">
                                <div class="infor_detail_top">
                                    <div class="infor_detail_top_title">
                                        <a href="{{ rewriteProduct($hotDealProducts['product_id'],$hotDealProducts['product_alias'],$hotDealProducts['product_name']) }}" rel="nofollow">
                                            <img class="infor_detail_img lazyload" 
                                            onerror="this.onerror=null; this.src='{{ asset('images/icon/load.gif') }}';"
                                            src="{{ asset('images/product_sample/anh1.jpg') }}"
                                            data-src="{{ asset($url_avarta) }}?v={{ time() }}" alt="anh">
                                        </a>
                                        <a href="{{ rewriteProduct($hotDealProducts['product_id'],$hotDealProducts['product_alias'],$hotDealProducts['product_name']) }}" rel="nofollow" class="infor_detail_name font_s16 line_h20 font_w500">{{ $hotDealProducts['product_name'] }}</a>
                                    </div>
                                ...
                                <div class="infor_detail_bottom">
                                    <button class="infor_detail_bottom_button" data-user="{{ $dataAll['data']['data']['us_id'] ?? 0 }}" data-product-code="{{ $hotDealProducts['product_code'] }}" onclick="addCart(this)">
