                ...
                <div class="content_home_center_right">
                    <div class="ct_home_center_frame w100 d_flex">
                        ...
                        <?php
                            ...
                            $product_colors = explode(',',$newProducts['product_colors']);
                            $product_classification = explode(';',$newProducts['product_classification']);
                            $product_stock = explode(';',$newProducts['product_stock']);
                            $product_price = explode(';',$newProducts['product_price']);
                            ...
                            // Bảng khuyến mãi
                            $discount_active = $newProducts['discount_active'];
                            $discount_type = $newProducts['discount_type'];
                            $discount_start_time = $newProducts['discount_start_time'];
                            $discount_end_time = $newProducts['discount_end_time'];
                        ...
                        <div class="home_center_item"
                            ...
                            <div class="home_center_item_desc">
                                <h3 class="hct_item_desc font_s16 line_h24 font_w600" title="{{ $newProducts['product_name'] }}">{{ $newProducts['product_name'] }}</h3>
                                ...
                                <div class="hct_item_infor_detail">
                                    <div class="infor_detail_top">
                                        ...
                                        <div class="infor_detail_top_des">
                                            ...
                                            <p class="infor_detail_brand">Thương hiệu: <span class="span_brand">{{ $newProducts['product_brand'] }}</span></p>
                                    ...
                                    <div class="infor_detail_bottom">
                                        <button class="infor_detail_bottom_button" data-user="{{ $dataAll['data']['data']['us_id'] ?? 0 }}" data-product-code="{{ $newProducts['product_code'] }}" onclick="addCart(this)">
